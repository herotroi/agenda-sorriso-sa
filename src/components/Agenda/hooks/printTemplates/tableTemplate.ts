...
export const generateTablePrintTemplate = (
  ...
  // Usar apenas agendamentos; NÃO incluir pausas ou férias
  ...
  return `
    <div style="border-radius: 8px; border: 1px solid #e5e7eb; padding: 24px; font-family: system-ui, -apple-system, sans-serif;">
      ...
      <div style="overflow-x: auto;">
        <table style="width: 100%; border-collapse: collapse; margin-top: 16px; border: 1px solid #000; table-layout: fixed;">
          <thead>
            <tr>
